...
public class GameRoomUseCaseTest {
        ...
        void leaveGameRoom_WhenHostLeaves_Test() {
                ...
                // then
                // assertEquals(true,
                // gameRoomRepository.findById(gameRoom.getId()).orElseThrow().getDeleted());
        ...
        void joinGameRoomUseCase_WhenPlayerAlreadyInRoom_Test() {
                ...
                // when
                joinGameRoomUseCase.executeV1(member1, gameRoom.getId(), request);
                // assertThrows(Exception.class, () -> joinGameRoomUseCase.executeV1(member1,
                // gameRoom1.getId(), request));
        ...
        void findGameRoomDetailUseCaseTest() {
                ...
                // then
                GameRoomDetailResponse response = getGameRoomDetailUseCase.execute(member, gameRoom.getId());

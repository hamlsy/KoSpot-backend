...
//
//import com.kospot.domain.multiGame.roundResult.repository.PhotoPlayerRoundResultRepository;
//import com.kospot.domain.multiGame.roundResult.repository.PhotoRoundResultRepository;
...
//                .orElseThrow(() -> new Exception(ErrorStatus.GAME_NOT_FOUND));
//
//        PhotoGameRound round = photoGameRoundRepository.findByMultiPhotoGameIdAndRoundNumber(gameId, roundNumber)
//                .orElseThrow(() -> new Exception(ErrorStatus.ROUND_NOT_FOUND));
//
//        // 2. 라운드 결과 생성

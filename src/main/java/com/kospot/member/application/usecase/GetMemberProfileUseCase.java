...
import com.kospot.member.presentation.response.MemberProfileResponse.GameStatistics.PhotoGameStats;
import com.kospot.member.presentation.response.MemberProfileResponse.GameStatistics.GameModeStats;
import com.kospot.member.presentation.response.MemberProfileResponse.GameStatistics.MultiGameStats;
import com.kospot.member.presentation.response.MemberProfileResponse.RankInfo;
import com.kospot.member.presentation.response.MemberProfileResponse.RankInfo.RoadViewRank;
import com.kospot.member.presentation.response.MemberProfileResponse.RankInfo.PhotoRank;
